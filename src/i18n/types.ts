...
export type AppMessages = {
  ...
  preview: {
    ...
    exportCheckTitle: string;
    exportCheckDescription: string;
    exportReady: string;
    exportBlocked: string;
    exportConditionRendered: string;
    exportConditionSvg: string;
    exportConditionSyntax: string;
    exportConditionFilename: string;
    noErrorTitle: string;
    noErrorDescription: string;
    errorSummary: string;
    repairSuggestion: string;
    errorLine: (line: number) => string;
    errorRule: string;
    noRepairSuggestion: string;
